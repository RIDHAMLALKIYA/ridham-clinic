        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center lg:items-start text-left">
          ...
          <div className="w-full lg:w-5/12 pt-6">
            <AnimatedWrapper direction="right">
              <div className="mb-12 text-left">
                ...
                <h1 className="text-4xl sm:text-6xl lg:text-[7rem] font-black text-slate-900 dark:text-white tracking-tighter leading-[0.9] lg:leading-[0.8] mb-8 lg:mb-12">
              ...
              <p className="text-lg md:text-2xl text-slate-500 dark:text-slate-400 font-medium mb-12 leading-relaxed max-w-lg tracking-tight">
                {t('home.subtitle')}
              </p>

              <div className="space-y-4 md:space-y-6">
                <div className="group flex items-center gap-4 md:gap-8 p-6 md:p-8 rounded-[2rem] md:rounded-[3rem] bg-white/40 dark:bg-white/5 backdrop-blur-3xl border border-white/50 dark:border-white/10 shadow-xl transition-all duration-700 hover:scale-[1.02] active:scale-95">
                  <div className="bg-emerald-500 p-3 md:p-5 rounded-2xl flex-shrink-0 shadow-[0_15px_30px_-10px_rgba(16,185,129,0.4)] transition-transform group-hover:rotate-12">
                    <Clock className="w-5 h-5 md:w-7 md:h-7 text-white" />
                  </div>
                  <div>
                    <h3 className="font-black text-slate-900 dark:text-white text-base md:text-xl tracking-tight uppercase">
                      {t('home.vip_scheduling')}
                    </h3>
                    <p className="text-slate-500 dark:text-slate-400 font-bold text-[8px] md:text-[10px] mt-1 uppercase tracking-[0.3em]">
                ...
                <div className="group flex items-center gap-4 md:gap-8 p-6 md:p-8 rounded-[2rem] md:rounded-[3rem] bg-white/40 dark:bg-white/5 backdrop-blur-3xl border border-white/50 dark:border-white/10 shadow-xl transition-all duration-700 hover:scale-[1.02] active:scale-95">
                  <div className="bg-teal-500 p-3 md:p-5 rounded-2xl flex-shrink-0 shadow-[0_15px_30px_-10px_rgba(20,184,166,0.4)] transition-transform group-hover:scale-110">
          ...
          <div className="w-full lg:w-7/12">
            <AnimatedWrapper direction="left" delay={0.4} tilt>
              <div className="glass-vip-polished rounded-[3rem] md:rounded-[4.5rem] shadow-[0_80px_160px_-40px_rgba(0,0,0,0.15)] dark:shadow-none border border-white/40 dark:border-white/10 relative group transition-all duration-1000 border-beam overflow-hidden">
                <form
                  action={createBooking}
                  className="px-6 py-10 md:p-20 space-y-10 md:space-y-12 relative z-20"
                >
                  ...
                  <div className="flex flex-col gap-8 md:gap-12">
                    ...
                    <div className="group/input text-left">
                      <label
                        htmlFor="name"
                        className="block text-[10px] md:text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-3 md:mb-4 ml-2"
                      >
                        {t('home.form.name')}
                      </label>
                      <div className="relative">
                        <div className="absolute inset-y-0 left-0 pl-5 md:pl-8 flex items-center pointer-events-none text-slate-400 group-focus-within/input:text-emerald-500 transition-colors duration-500">
                    ...
                    <div className="group/input text-left">
                      ...
                      <div className="relative flex flex-col md:flex-row gap-3 md:gap-4">
                        <div className="relative w-full md:w-1/3 min-w-[120px]">
                          <select
                            name="countryCode"
                            className="block w-full px-5 py-4 md:py-7 text-slate-950 dark:text-white bg-white dark:bg-black/60 border border-slate-200 dark:border-white/10 rounded-[1.5rem] md:rounded-[2.5rem] appearance-none cursor-pointer text-base md:text-xl font-bold outline-none focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 transition-all shadow-sm"
                            defaultValue="+91"
                          >
                        ...
                        <div className="relative flex-1">
                          <input
                            ...
                            pattern="[0-9]{10}"
                            inputMode="numeric"
                            className="block w-full px-6 md:px-10 py-5 md:py-7 text-slate-950 dark:text-white bg-white dark:bg-black/60 border border-slate-200 dark:border-white/10 rounded-[1.8rem] md:rounded-[2.5rem] focus:outline-none focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 transition-all duration-700 text-lg md:text-2xl font-bold placeholder:text-slate-400 dark:placeholder:text-slate-700"
