...
import { Clock, Users, ShieldCheck, User, Phone, CheckCircle2, Stethoscope, Heart, Activity, Zap, ShieldAlert } from 'lucide-react';
                ...
                <AnimatedWrapper className="max-w-2xl mx-auto" tilt>
                    <div className="glass-vip-polished rounded-[3.5rem] p-12 md:p-24 text-center relative group border-beam overflow-hidden">
                        ...
                        <p className="text-xl text-slate-500 dark:text-slate-400 font-medium leading-relaxed max-w-md mx-auto">
                            You have been integrated into the live clinical stream. Proceed to the main lobby area.
                        </p>
                        <a
                            href="/queue"
                        ...
                        <AnimatedWrapper direction="right">
                            <div className="mb-12">
                                <div className="inline-flex items-center gap-3 px-4 py-2 bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-full mb-8 shadow-sm">
                                    ...
                                    <span className="text-[10px] font-black text-slate-500 dark:text-emerald-400 uppercase tracking-[0.3em]">Authorized Access Node</span>
                                </div>
                                <h1 className="text-6xl sm:text-7xl lg:text-[6rem] font-black text-slate-900 dark:text-white tracking-tighter leading-[0.85] mb-10">
                                    Queue <br />
                                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-teal-500 drop-shadow-[0_0_30px_rgba(16,185,129,0.2)]">Portal</span>.
                                </h1>
                            </div>
                            <p className="text-xl text-slate-500 dark:text-slate-400 font-medium mb-14 leading-relaxed max-w-md tracking-tight">
                                Synchronize your arrival with our smart clinic network. Precision timing for elite care.
                            </p>
                            ...
                            <div className="grid grid-cols-1 gap-6 max-w-sm">
                                <div className="group flex items-center gap-6 p-6 rounded-[2.5rem] bg-white/40 dark:bg-white/5 backdrop-blur-3xl border border-white/50 dark:border-white/10 shadow-lg transition-all hover:scale-105 active:scale-95">
                                    ...
                                    <div>
                                        <h3 className="font-black text-slate-900 dark:text-white text-lg tracking-tight uppercase">Instant Sync</h3>
                                        <p className="text-slate-500 text-[10px] font-black mt-1 uppercase tracking-[0.2em] opacity-60">Verified Credentials Only</p>
                                    </div>
                                </div>
                            </div>
                        </AnimatedWrapper>
                            ...
                            <div className="glass-vip-polished rounded-[4.5rem] shadow-[0_64px_128px_-32px_rgba(0,0,0,0.15)] dark:shadow-none border border-white/40 dark:border-white/10 relative overflow-hidden transition-all duration-1000 border-beam">
                                ...
                                {success === 'registered' && (
                                    <div className="mx-12 mt-12 p-6 bg-emerald-500/10 border border-emerald-500/20 rounded-[2.5rem] flex items-start gap-5 backdrop-blur-xl animate-scale-in">
                                        ...
                                        <div className="text-left">
                                            <h4 className="text-emerald-500 font-black text-xs uppercase tracking-[0.2em]">Node Registered</h4>
                                            <p className="text-[10px] text-emerald-500/70 mt-1.5 font-bold uppercase tracking-widest leading-relaxed">Identity verified. Awaiting clinic activation beacon.</p>
                                        </div>
                                    </div>
                                )}
                                ...
                                {error && (
                                    <div className="mx-12 mt-12 p-6 bg-red-500/10 border border-red-500/20 rounded-[2.5rem] flex items-start gap-5 backdrop-blur-xl animate-bounce-in">
                                        ...
                                        <div className="text-left">
                                            <h4 className="text-red-500 font-black text-xs uppercase tracking-[0.2em]">Sync Error</h4>
                                            <p className="text-[10px] text-red-500/70 mt-1.5 font-bold uppercase tracking-widest leading-relaxed">
                                                {error === 'not_found' ? 'Identity mismatch. Registration required.' :
                                                    error === 'no_appointment' ? 'No active session scheduled for current time node.' :
                                ...
                                >
                                    <div className="flex flex-col gap-12">
                                        <div className="group/input text-left font-outfit">
                                            ...
                                            <div className="relative">
                                                <div className="absolute inset-y-0 left-0 pl-8 flex items-center pointer-events-none text-slate-400 group-focus-within/input:text-emerald-500 transition-colors">
                                        ...
                                        <div className="group/input text-left font-outfit">
                                            ...
                                            <div className="relative flex gap-4">
                                                <div className="relative w-1/3 min-w-[140px]">
                                                    <select
                                                        name="countryCode"
                                                        className="block w-full px-6 py-7 text-slate-950 dark:text-white bg-white dark:bg-black/60 border border-slate-200 dark:border-white/10 rounded-[2.5rem] appearance-none cursor-pointer text-xl font-bold outline-none"
                                                        defaultValue="+91"
                                                    >
                                        ...
                                        <div className="bg-red-500/5 dark:bg-red-500/10 border border-red-500/20 rounded-[2.5rem] p-8 transition-all hover:bg-red-500/10 group/urgent">
                                            <div className="flex items-center justify-between gap-6">
                                                <div className="text-left">
                                                    ...
                                                    <p className="text-[10px] text-red-500/60 font-bold mt-2 uppercase tracking-widest">Mark this if you need immediate attention.</p>
                                                </div>
                                    ...
                                    <div className="pt-6 flex flex-col items-center gap-10">
                                        <CheckInButton className="w-full py-10 rounded-[3rem] shadow-[0_20px_50px_-10px_rgba(16,185,129,0.5)]" />

                                        <div className="w-full h-px bg-slate-200 dark:bg-white/10 relative">
                                            <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-white dark:bg-[#0d0d0d] px-6 text-[10px] font-bold text-slate-400 uppercase tracking-widest">Need to Register?</span>
                                        </div>
                                        ...
                                        >
                                            First regular visit? <span className="text-emerald-500 underline decoration-emerald-500/30 group-hover:decoration-emerald-500 underline-offset-8">Book an Appointment</span>
                                        </a>
                                    </div>
                                </form>
                            </div>
