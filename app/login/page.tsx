                    ...
                    <div className="glass-vip-polished rounded-[3.5rem] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.3)] border border-white/10 overflow-hidden relative group/card border-beam">
                        <div className="p-8 md:p-14 relative z-10">
                            <div className="flex flex-col items-center mb-10 md:mb-12">
                                ...
                                <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tighter uppercase">Protocol Entry</h1>
                                <div className="flex items-center gap-3 mt-3">
                                    <div className="w-1.5 h-1.5 bg-emerald-500 rounded-full animate-pulse"></div>
                                    <p className="text-[10px] text-slate-500 dark:text-slate-400 font-black uppercase tracking-[0.4em]">Authorities Only</p>
                                </div>
                            </div>
                            ...
                            <form action={async (formData) => {
                                try {
                                    ...
                                    if (typeof e === 'object' && e !== null && 'digest' in e && (e as any).digest?.startsWith('NEXT_REDIRECT')) throw e;
                                    throw e;
                                }
                            }} className="space-y-8">
                                <div className="space-y-3">
                                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] mb-2 block ml-2">Neural Node Email</label>
                                ...
                                <div className="space-y-3">
                                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] mb-2 block ml-2">Authorization Secret</label>
                                    <div className="relative group/input">
                                ...
                                <div className="pt-6">
                                    ...
                                    <p className="mt-8 text-[9px] text-slate-400 font-black uppercase tracking-[0.5em] text-center opacity-40">
                                        Encrypted Session ID: VIP-{Math.random().toString(36).substring(7).toUpperCase()}
                                    </p>
                                </div>
                            </form>
                            ...
                            <div className="mt-10 pt-10 border-t border-slate-100 dark:border-white/5">
                                <form action={async () => {
                                    ...
                                    <button type="submit" className="w-full flex items-center justify-center gap-3 py-4 px-6 rounded-[1.5rem] border border-dashed border-slate-200 dark:border-white/10 text-slate-400 font-black text-[10px] uppercase tracking-widest hover:bg-emerald-500/5 hover:border-emerald-500/50 hover:text-emerald-500 transition-all group/btn">
